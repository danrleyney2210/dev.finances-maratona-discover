const Modal = {
  open(){
    //Open the Modal to add the class in the modal
    document.querySelector('.modal-overlay').classList.add('active')
  },
  close(){
    //Close the modal and remove the class active in the modal
...
const Transaction = {
  ...
  total() {
    ...
    if (total < 0) {
      ...
      document.querySelector('.card.total').style.backgroundColor = '#60a36c';
    }
    return total
